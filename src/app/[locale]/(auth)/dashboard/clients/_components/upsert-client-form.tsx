...
import { useEffect, forwardRef, useState, InputHTMLAttributes } from "react";
...
const CustomNumericInput = forwardRef<HTMLInputElement, InputHTMLAttributes<HTMLInputElement>>(
  ({ className, value, ...rest }, ref) => {
    return <Input className={className} ref={ref} value={value || ""} {...rest} />;
  },
);
...
const UpsertClientForm = ({
  ...
  const { execute, isLoading: isSubmitting } = useAction(upsertClient, {
    ...
    onError: (error) => {
      ...
      openValidationErrorsModal([errorMessage]);
    },
  });
  ...
  const form = useForm({
    ...
    defaultValues: initialData
      ? {
          ...
          vlrMens: initialData.vlrMens !== null && initialData.vlrMens !== undefined
            ? typeof initialData.vlrMens === 'string'
              ? Number(initialData.vlrMens)
              : initialData.vlrMens
            : undefined,
  ...
  useAction(getCnpjInfo, {
    ...
    onError: (error) => {
      ...
      if (error && typeof error === 'object') {
        ...
        if ('error' in error && typeof (error as any).error === 'object' && 'serverError' in (error as any).error) {
          errorMessage = ((error as any).error as any).serverError || errorMessage;
        }
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Melhor Dia" {...field} value={field.value || ""} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Email Principal" {...field} value={field.value || ""} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Email 1" {...field} value={field.value || ""} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Email 2" {...field} value={field.value || ""} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Email 3" {...field} value={field.value || ""} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Email 4" {...field} value={field.value || ""} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Email 5" {...field} value={field.value || ""} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
