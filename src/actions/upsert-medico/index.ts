...
// A lógica principal da action, agora usando o contexto do protectedAction
...
// Exporta a action usando o padrão do projeto e o protectedAction
export const upsertMedico = async (input: z.infer<typeof upsertMedicoSchema>) => {
  return protectedAction.schema(upsertMedicoSchema).action(handler)(input);
};
